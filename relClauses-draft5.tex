...
\comment{Maybe, point out that Mundabli has both, a non-concordant marker more generally used as subordinator which is probably cognate with the Mungbam non-concordant relative marker and a concordant relative marker?}
...
then \cl7-matter {\sc rel} 1sg-b.want 1sg-c.talk.{\sc irr} ({\sc a})discuss.{\sc irr} {\sc vent.irr} {\sc \cl7.foc} thus	\\
...
\begin{xlist}
\ex     \gll \uline{\`mb\`\oo{\ng}} \ny\'{\i} $[$N\H{a}{\ng} h\H{a} l\Lbi{\ng}$]$ {\`\aw} \`u p\'\i\til{p\H{\i}}        \\
\cl1.cow {\sc rel} N. {\sc p1} ({\sc a})look.for {\sc \cl1.det} \cl1 {\sc vfoc}\til{b.die} \\
\glt \elicited``The cow that Nang looked for died.'' (Abar)      \label{mg03a}
\ex     \gll \uline{\`mb\`\oo{\ng}} \ny\'{\i} $[$N\H{a}{\ng} h\H{a} l\Lbi{\ng} \uline{w\`u}$]$ {\`u}{\footnotemark} \`u p\'\i\til{p\H{\i}}     \\
\cl1.cow {\sc rel} N. {\sc p1} ({\sc a})look.for {\sc \cl1.foc} {\sc \cl1.det} \cl1 {\sc vfoc}\til{b.die}  \\
...
1sg-{\sc p1} {\sc vfoc}\til{b.see} \cl5-place {\sc rel} N. {\sc p1} ({\sc a})slaughter \cl10-fowl \cl10.{\sc det} (there)	\\
...
c.hang.{\sc ipfv} ({\sc b})keep.{\sc ipfv} \cl12-dress \cl12-some {\sc prep} {\sc loc.}on	\\
...
{\sc comp} \cl1 ({\sc b})give.{\sc irr} \cl12-thing \cl12-b.carry.water-{\sc adj} \cl6a-water	\\
...
\ea	\label{missong01a}
	...
	\cl1.{\sc nmlz}-a.fall-{\sc nmlz} {\sc rel} N. {\sc p1} ({\sc a})fall \cl1 {\sc loc.}at {\sc \cl1.det} {\sc p1} {\sc vfoc}\til{c.bad}	\\
...
\ea 	\label{abar01a}
	\gll {u}-w\`{\@}n\`{\aw} \`u l\H{\eh} \uline{\`u-n\`o} {\ny}\={\i} $[$\'n={\dzh}\=a \=\i-{\sh}\ML{\eh} \uline{j\`{\i}}$]$       \\
        \cl1-{\sc dem.prox} \cl1 ({\sc b}){\sc cop} \cl1-person {\sc rel} {\sc 1sg}=a.steal.{\sc irr} \cl9-fowl {\sc 3sg.poss}     \\
...
b.block.{\sc ipfv} ({\sc a})stay.{\sc ipfv} {\sc 1sg.foc}	\\
...
\cl5-{\sc dem.prox} {\sc neg} \cl5-b.tired.{\sc inf} \cl5-other N. {\sc p1} ({\sc b})tired {\sc frust}	\\
...
\cl1-person {\sc rel} {\sc ds} ({\sc a})fall {\sc \cl1.foc} {\sc \cl1.det} \cl1 {\sc vfoc}\til{b.die}	\\
...
\cl1-person {\sc rel} {\sc ds} ({\sc c})insult N. {\sc \cl1.foc} {\sc \cl1.det} \cl1 {\sc vfoc}\til{b.die}	\\
...
\cl1-person {\sc rel} N. {\sc \cl1.foc} {\sc neg} ({\sc a})insult.{\sc irr} {\sc neg2} {\sc \cl1.det} \cl1 {\sc vfoc}\til{b.die}	\\
...
\cl1-person \cl1-{\sc rel} \cl1.{\sc top} ({\sc a})fall {\sc \cl1.det} \cl1.{\sc top} {\sc vfoc}\til{b.die}	\\
...
\footnotetext{Examples of such headless relative clauses in German are \gl{Ich weiSZ, wo sie wohnt.} and \gl{Ich weiSZ, woran Du denkst.}.}
\comment{Check footnotetext! Does this make sense? or is this an adverbial clause? How do I encode the German sz symbol?}
...
\begin{exe}
	\ex \label{exSheSaidAyi} 		
		...
		\cl1  ({\sc b})say	{\sc excl} {\sc 1sg.top}={\sc fut1}	c.go.up	there		\cl5/7.attic 	
...
%		{\sc 1sg.top}=a.love 7/8.clothes 7-{det} {\sc rel} ({\sc b})buy 7-{\sc det} name 7 	\\
...
\begin{exe}
	\ex \label{exThisChildYouAre} 		
		\gll wān w-ɛ̄n, dɨ̌ \uline{wà} nō̤ [\uline{à} lə̄ w-ɔ̄ ná	mɨ̄ wān w-ɔ̄ lɛ̄ fán gbɔ̄ kúŋ]\\
			\cl1.child	\cl1-{\sc dem.prox} ({\sc b})be	{\sc 2sg.foc}	{\sc subd} {\sc 2sg.top} ({\sc a})make	\cl1-{\sc rel}	  as	{\sc 1sg.foc} \cl1.child	\cl1-{\sc det}	a.make.ipfv	here \cl3.house	behind \\
...
%			Wum {\sc loc}.village {\sc subd} \cl1  ({\sc b})be \cl1-{\sc rel} \cl5/6.village {\sc advlz} \cl19-small , \cl7  {\sc neg}1 be.far {\sc neg}2 \\
...
\begin{exe} 
	\ex \label{exThenFromThen}	
		\gll	then from then, mɨ̄ m=fə̋ kì-yùŋn{\`\ih} bɔ̌ gbàm lā nō̤ wù fə̋ ná kpɒ̋ ŋgɔ́ w-ɔ́ ndá lā			\\
			then from then {\sc 1sg.foc} {\sc 1sg.top}=b.give \cl7-thanks also \cl7/8.god {\sc dat} {\sc subd} \cl1 ({\sc b})give  as \cl5/7.money upon \cl5-{\sc det} {\sc 1sg.dat} {\sc dat}		\\
...
\begin{exe}
	\ex \label{exThePersonWhoWasPreaching2} 		
		...
		\cl1.man	\cl1 	{\sc p3}	b.say.{\sc ipfv}	\cl1-{\sc rel}	\cl3a.word \cl7/8.god	\cl7/8.day	\cl7-{\sc det}	 upon	{\sc p3}	b.be	Pa P. K. \\
...
\begin{exe}
	\ex \label{exWhenYouHaveFinishedSquishing} 		
		...
		when	{\sc 2sg.top}	a.squish	a.finish		when	{\sc 1sg.top}=b.drink	{\sc 1sg.foc}	{\sc 1sg.top}=a.show	\cl9/10.place	{\sc subd}			\cl1.child		\cl1-{\sc 2sg.poss}	{\sc p3}	b.pass	{\sc prox}-{\sc rel}	\\
...
%\begin{exe}
	\ex \label{exThePeopleForWhomWithPro}	
		...
		\cl2.people {\sc subd} \cl1  {\sc p3} ({\sc b})cook.{\sc ipfv} \cl2-{\sc rel} ({\sc loc}) \cl2  {\sc dat} \cl2  {\sc p3} ({\sc a})be.rich	\\
...
%		{\sc 1sg.top}=b.ask QUOT.Q Q , ({\sc b})be what {\sc rel} {\sc 2sg.top} ({\sc b})refuse 7-{\sc det} 6a.wine 6a-{\sc det} {\sc 2sg.foc}-N {\sc loc}.hands Q.{\sc quot} \\
...
%		{\sc 1sg.top}=a.love 7/8.clothes 7-{\sc det} {\sc rel} Nyungfu ({\sc b})buy=7-{\sc det} 7 	\\
...
\begin{exe}
	\ex \label{exChildWhomIGaveMoney}	
		...
		\gll	\uline{wàn} w-ɔ̄ [nō̤ m=fə̋ fə̋ w-ɔ̄ kpɒ̋ {\H\ih} \uline{wú} lā] kɛ́ tʃǔ a̋ kè-kè	\\
			\cl1.child \cl1-{\sc det} {\sc subd} {\sc 1sg.top}={\sc p1} ({\sc b})give	\cl1-{\sc rel} \cl5/7.money {\sc loc} \cl1 {\sc dat} ({\sc c})return ({\sc b})come {\sc advlz} \cl9.hand-{\sc red} 				\\
...
\begin{exe} 
	\ex \label{exChildWhoseName}	
		...
		\gll	\uline{wān} [nō̤ mán \uline{mű} dɨ̋ w-ɔ̄ ngàʃǎ] fə̋ lɔ̀ ɲu᷇				\\
			\cl1.child {\sc subd} \cl11/12.name \cl12.{\sc 3sg.poss} ({\sc b})be \cl1-{\sc rel} N. {\sc p1} ({\sc a})go.bush \cl5/6.farm		\\
...
%		\cl1-{\sc det} \cl1.time {\sc rel} {\sc 1sg.top}=a.take only \cl1-{\sc rel} \cl8.things \cl8.{\sc 1sg.poss} now		\\
...
\begin{exe}
	\ex \label{exTheSoundThatThey}	
		\gll 	dzɛ̋ nō̤ bə̄ gbā ná kpān w-ɔ́ fyá mɨ̄ ā fa̋m	\\
			\cl5/6-sound {\sc subd} {\sc impers.pro} ({\sc a})cut.{\sc ipfv}  as \cl3.tree \cl3-{\sc det} ({\sc b})give.{\sc ipfv} {\sc 1sg.foc} {\sc com} \cl7/8.problem	\\
...
\comment{There should be an example of a comparable interrogative main clause here, but I cannot find an interrogative main clause with the Q word in a possessive or a comitative phrase.}
...
\begin{exe}
	\ex \label{exILikeTheClothesThatNyungfu}	
		...
		{\sc 1sg.top}=a.love \cl7/8.clothes \cl7-{\sc det} {\sc subd} ({\sc b})buy \cl7-{\sc rel} N. \cl7 	\\
...
\begin{exe}
	\ex \label{exILikeTheClothes}	
		...
		{\sc 1sg.top}=a.love \cl7/8.clothes \cl7-{\sc det} {\sc subd} Nyungfu ({\sc b})buy \cl7-{\sc rel} \cl7 	\\
...
\begin{exe} 
	\ex \label{exTheyAreNotListening}	
		...
		\gll 	bī ā wṳ́ wɔ̄ ɲɔ̄ ni̋	\\
		 	\cl8  {\sc neg} ({\sc b})hear.{\sc ipfv} 	{\sc neg} ({\sc b})talk	\cl1mother.{\sc 3sg.poss} \\
...
\begin{exe} 
	\ex \label{exIHaveNotTurnedFufu}	
		...
		\gll 	n=da̋ ɲɔ̋m wɔ̄ ɲa᷆m	\\
		 	{\sc 1sg.top}=b.be.{\sc neg} ({\sc b})turn.fufu  {\sc neg} \cl14.fufu	\\
		\glt \VSP \elicited \gl{I have not turned fufu yet.}
\end{exe}%

\comment{da̋ = dɨ̋ a̋ ? = ({\sc b})be still? DONAT}
...
\comment{Is regular negation really not attested in relative clauses???} 
...
\begin{exe} 
	\ex \label{exTheyTookTheBag}	
		...
		\gll 	bɔ̋ fə̋ mù \uline{bɔ̀} k-ɔ́ [nō̤ b{\=\ih} fə̋ dɨ̋ k-ɔ́ a̋ də̀ wɔ̄], bɔ̋ mɨ́ dʒì kǐ {\H\ih} kìa mɨ̄.	\\
		 	\cl2  {\sc p1} ({\sc a})take	\cl7.bag \cl7-{\sc det} {\sc subd} {\sc 1pl} {\sc fut1} ({\sc b})be \cl7-{\sc rel} {\sc neg} ({\sc a})see {\sc neg} \cl2  {\sc consec} ({\sc a})put \cl7  {\sc loc} \cl9.basket in \\
