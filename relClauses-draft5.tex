...
\begin{exe}
	...
	\ex \gll 	\uline{ŋwàtɨ̀} bi̋ bī-fyɨ̋ŋ b-ɛ́n bi̋-tɔ᷇ b-ɔ́ [nō̤ wù fə̌ ta̋ŋ b-ɔ́ Bàmɛ́ndà]		\\
			\cl7/8-book \cl8.1{\sc poss} \cl8-new \cl8-{\sc dem.prox} \cl8-three \cl8-{\sc det} {\sc subd} \cl1  {\sc p1} b.buy \cl8-{\sc rel} Bamenda 		\\
...
\begin{exe}
	\ex \label{exSheSaidAyi} 		
		...
		\cl1  b.say	{\sc excl} 1{\sc sg}={\sc fut}1	c.go.up	there		\cl5/7.attic 	
		1{\sc sg}=a.go	a.see clearly	\cl7.thing	\cl7	a.make.{\sc ipfv}	c.extinguish.{\sc ipfv} 	b.move.away.{\sc ipfv} \cl7-{\sc rel}	\cl5/7.fire	\cl5-{\sc det} \\
...
%		1{\sc sg}=a.love 7/8.clothes 7-{dist.dem} {\sc rel} b.buy=7-{\sc det} name 7 	\\
...
\begin{exe}
	\ex \label{exTheFirstThing} 		
		...
		first	\cl7.thing	{\sc subd} 1{\sc sg}={\sc fut}2	a.do	\cl7-{\sc rel}	\cl7 	b.{\sc cop}	 {\sc comp}	... \\
...
%			2{\sc sg.pvb}	a.see	8.things	8 	b.pass	8-{\sc det}	{\sc com}	2{\sc sg.pro.npvb} \\
...
%			Wum village.{\sc loc} {\sc rel} 1  b.be 1-{\sc det} 5/6.village {\sc advlz} 19-small , 7  {\sc neg}1 be.far {\sc neg}2 \\
...
%			1{\sc pl.pro} a.search 9.goat 9.certain  {\sc rel}	 9  {\sc p1} c.run 9-{\sc det}						\\
...
%			1{\sc pl.pro} a.search 9.goat {\sc rel}	 9  {\sc p1} c.run 9-{\sc det}						\\
...
%			1{\sc pl.pro} a.search 9.goat 9-{\sc det} {\sc rel}	 9  {\sc p1} c.run 9-{\sc det}						\\
...
\begin{exe} 
	\ex \label{exThenFromThen}	
		\gll	then from then, mɨ̄ m=fə̋ kì-yùŋn{\`\ih} bɔ̌ gbàm lā nō̤ wù fə̋ ná kpɒ̋ ŋgɔ́ w-ɔ́ ndá lā			\\
			then from then 1{\sc sg.foc} 1{\sc sg.top} \cl7-thanks also \cl7/8.god for {\sc subd} \cl1 b.give  as \cl5/7.money upon \cl5-{\sc det} 1{\sc sg.pro.dat} for		\\
...
%			1  c.sing b.good b.pass b.pass as 1  a.play as2		\\
...
\begin{exe}
	\ex \label{exThePersonWhoWasPreaching2} 		
		...
		\cl1.man	\cl1 	{\sc p3}	b.say.{\sc ipfv}	\cl1-{\sc rel}	\cl3a.word \cl7/8.god	\cl7/8.day	\cl7-{\sc dist.dem}	 upon	{\sc p3}	b.be	Pa Peter Kia \\
...
%		3.pot 3-{\sc det} {\sc rel} 2  {\sc p1} a.put c.enter a.go.down 3-{\sc det} w.beans w-{\sc det} in , 1  {\sc p1} b.be.big {\sc advlz} much?-{\sc red} 	\\
...
\begin{exe}
	\ex \label{exThePotIntoWhich2}	
		...
		\cl3.pot \cl3-{\sc det} {\sc subd} \cl2  {\sc p1} a.put c.enter a.go.down \cl3-{\sc rel} \cl3a.beans \cl3a-{\sc det} \cl5  in \cl1  {\sc p1} b.be.big {\sc advlz} much?-{\sc red} 	\\
		\glt \VSP \elicited \gl{The pot into which they put the beans was very big.}
\end{exe}%fieldnotes2012/p.50	%???
%\end{xlist}
%\end{exe}
...
\begin{exe}
	\ex \label{exWhenYouHaveFinishedSquishing} 		
		...
		when	2{\sc sg.top}	a.squish	a.finish		when	1{\sc sg}=b.drink	1{\sc sg.foc}	1{\sc sg}=a.show	\cl?.place	{\sc subd}			\cl1.child		\cl1-2{\sc sg.poss}	{\sc p3}	disappear	{\sc prox}-{\sc rel}	\\
...
%		2.people {\sc rel} 1  {\sc p3} b.cook.{\sc ipfv} 2-{\sc det} {\sc loc} {\sc dat} , 2  {\sc p3} a.be.rich	\\
...
%		9.knife {\sc rel} 1  {\sc p1} b.cut 9-{\sc det} 9.meat 9-{\sc det} {\sc com} 9 9 {\sc p1} a.be.blunt	\\
...
%		9.knife {\sc rel} 1  {\sc p1} b.cut 9-{\sc det} 9.meat 9-{\sc det} {\sc com}, 9  {\sc p1} a.be.blunt	\\
...
%		1  ?.take b.come ?.basket , 1  {\sc consec} ?.put ?.cassava ({\sc loc}) in	\\
...
%		1{\sc sg.pro}=a.love 7/8.clothes 7-{\sc det} {\sc rel} Nyungfu b.buy=7-{\sc det} 7 	\\
...
\begin{exe}
	\ex \label{exChildWhomIGaveMoney}	
		...
		\gll	\uline{wàn} w-ɔ̄ [nō̤ m=fə̋ fə̋ w-ɔ̄ kpɒ̋ {\H\ih} \uline{wú} lā] kɛ́ tʃǔ a̋ kè-kè	\\
			\cl1.child \cl1-{\sc det} {\sc subd} 1{\sc sg.top}={\sc p1} b.give	\cl1-{\sc rel} \cl5/7.money {\sc loc} 1  {\sc dat} c.return b.come {\sc advlz} \cl9.hand-{\sc red} 				\\
...
\begin{exe}
	\ex \label{exTheHoeWithWhich}	
		\gll	\uline{ŋkɔ̀m} [nō̤ ntí fə̋ lɔ̄ w-ɔ̄ ā \uline{wù}] kwa᷆ fɨ̌  	\\
			\cl1/2.hoe {\sc subd} Ntie {\sc p1} a.go.bush	\cl1-{\sc rel} {\sc com} \cl1 a.break b.pass 				\\
...
%		7  {\sc cop} only 7/8.day 6a.corn.beer 9(?).die 8-{\sc dem} {\sc rel} prop.name {\sc fut2} b.come 8-{\sc det} with 9.goat	\\
...
\begin{exe}
	\ex \label{exTheKnifeTheyCutWhat}	
		...
		\cl9-this {\sc cop} \cl9.knife {\sc subd} {\sc impers.pro} {\sc p1} b.cut \cl9-{\sc rel} what {\sc com} \cl9 	\\
...
\begin{exe}
	\ex \label{exILikeTheClothesThatNyungfu}	
		...
		1{\sc sg.pro}=a.love \cl7/8.clothes \cl7-{\sc det} {\sc subd} b.buy \cl7-{\sc rel} Nyungfu \cl7 	\\
...
\begin{exe}
	\ex \label{exILikeTheClothes}	
		...
		1{\sc sg.pro}=a.love \cl7/8.clothes \cl7-{\sc det} {\sc subd} Nyungfu b.buy \cl7-{\sc rel} \cl7 	\\
...
%		 	7/8.day	certain	8.suffering 	catch	8-{\sc det} 1 	7/8.thousand cl.8-those	cl.8-five	{\sc neg}1 b.be	{\sc neg}2	\\
...
\begin{exe} 
	\ex \label{exTheyAreNotListening}	
		...
		\gll 	bī ā wṳ́ wɔ̄ ɲɔ̄ ni̋	\\
		 	\cl8  {\sc neg} b.hear.{\sc ipfv} 	{\sc neg} b.talk	mother.3{\sc poss} \\
...
\begin{exe} 
	\ex \label{exTheyTookTheBag}	
		...
		\gll 	bɔ̋ fə̋ mù \uline{bɔ̀} k-ɔ́ [nō̤ b{\=\ih} fə̋ dɨ̋ k-ɔ́ a̋ də̀ wɔ̄], bɔ̋ mɨ́ dʒì kǐ {\H\ih} kìa mɨ̄.	\\
		 	\cl2  {\sc p1} a.take	\cl7.bag \cl7-{\sc det} {\sc subd} 1{\sc pl.pro} {\sc fut1} b.be \cl7-{\sc rel} {\sc neg} a.see {\sc neg} \cl2  {\sc consec} a.put \cl7  {\sc loc} \cl9.basket in \\
