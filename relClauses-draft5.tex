...
\usepackage[text={6.5in,9.5in}, papersize={8.5in,11.55in}, centering]{geometry}
...
\setromanfont[Mapping=tex-text,Renderer=ICU]{Charis SIL}
...
NSF grant BSC-0853981, University at Buffalo College of Arts and Sciences Humanities Institute, Leiden University Fund and Leiden University Centre for Linguistics at Leiden University.
...
\hline
gb{\=\aw}	&	\'u-kp\H{e}	&	\gl{\cl3.house}	&	dz\=\aw	&	\'\i-kp\H{e}	&	\gl{\cl4.houses}	\\
y\H{\ih}	&	\'\i-dz\H{\eh}h\eh&	\gl{\cl5.eye}	&	y\H{\ih}&	\'a-dz\H{\eh}h\eh&	\gl{\cl7/\cl6.eyes}	\\
k\=\oo		&	\`a-k\ML{\@}f\@	&	\gl{\cl7/\cl12.bone}&	k\=\oo	&	b\=\i-k\ML{\@}f\@&	\gl{\cl8.bones}		\\	% 26-may-2008 jcg tape
\dzh\v{u}	&	\`\i-b\'e	&	\gl{\cl9.goat}	&	\dzh\H{u}&	\'\i-b\H{e}	&	\gl{\cl10.goat}		\\
\Hline
\end{tabular}
...
P0,P1,P2, and P3 here). Mungbam has one
future tense, while Mundabli has two.
...
realis irrealis mood on the other (see~\tref{tblConjugation}).
...
\Hline
        &                       &       {\sc pfv}       &       {\sc ipfv}      \\
\hline
A       &       {\sc realis}    &       \`x             &       \`x $+$ {\sc abl}       \\
        &       {\sc irr}       &       \={x}           &       \={x} $+$ {\sc abl}     \\
\hline
B       &       {\sc realis}    &       \H{x}           &       \^x $+$ {\sc abl}       \\
        &       {\sc irr}       &       \ML{x}          &       \'{x} $+$ {\sc abl}     \\
\hline
C       &       {\sc realis}    &       \^x             &       \^x $+$ {\sc abl}       \\
        &       {\sc irr}       &       \'{x}           &       \'{x} $+$ {\sc abl}     \\
\Hline
\end{tabular}
\caption{Verb conjugation in Mungbam. Tone diacritics are interpreted as
follows: \`x $=$ L, \={x} $=$ M, \={x}\`{} $=$ ML, \'{x} $=$ H, \^{x} $=$ HL,
\H{x} $=$ S(uperhigh). {\sc abl}$=$ `ablaut'.
...
\footnotetext{
	...
	of the verbal suffix *-\textit{\ih{}l}- in Narrow Bantu
...
\begin{figure}[p]
\centering
\includegraphics[width=5in]{LowerFungomLanguagesMap.pdf}
\caption{Lower Fungom and surrounding area}\label{lfmap}
\end{figure}%%%
...
The use of the [\textsubumlaut{x}] diacritic, normally reserved to indicate breathy voice,
is used to indicate what has been described as pharyngealisation of
vowels in Mundabli. 
Also, the symbol [y] indicate a palatal glide in Mundabli. 
In Mungbam a palatal glide is indicated by the IPA symbol [j]. Additionally, we prefer to use the now outdated
symbol~[\,\scalebox{1.5}{{\ih}}\,] rather than the currently-recommended~[\,\scalebox{1.5}{{\tp{I}}}\,]
...
\cl4a-place {\sc 1sg.poss} {\sc \cl4a.dem.prox} {\sc rel} \cl6a-water {\sc \cl6a.det} a.stay.{\sc pfv} {\sc cl4.det}		\\
...
\begin{tabular}{llll}
\Hline
a,b,c	&	verbal conjugation class	&	\cl1\dots19	&	noun class	\\
...
{\sc excl}&	exclamatory			&	{\sc fut}&	future	\\
{\sc foc}&	focus-field form		&		&		\\
{\sc frust}&	frustal				&	{\sc ideo}&	ideophone	\\
{\sc ipfv}&	imperfective			&	{\sc irr}&	irrealis	\\
{\sc loc}&	locative			&	{\sc neg}&	negative	\\
{\sc nmlz}&	nominalizer			&	{\sc poss}&	possessive	\\
{\sc pre}&	preposition			&	{\sc prf}&	perfect		\\
...
the Bamil\'ek\'e language Fe{\textraiseglotstop}Fe{\textraiseglotstop} \citepp{chumbow:1977}{289},
...
\hline
Munken	&	n\'{\@}		&	-l\eh			&\mbox{\'a-mj\H{u}}	&-\ny\@{m\@}				\\
Ngun	&	n\'{\ih}	&	-ne			&k\'{\@}-mj\H{\ih}	&					\\	%9/11 22-apr-2010
Biya	&	-n\ih		&	-n\ih			&k\'{\@}-mj\H{\ih}	&-kj\ih					\\
Abar	&	\ny\'\i		&	-lehe			&k\'{\@}-\ny\H{u} 	&-\ny{i}				\\
Missong	&	n\'a		&	-l\eh			&k\'\i-n\H{a}		&-n\={\@}			\\	%83v
\Hline
\end{tabular}
...
five {\sc rel} \cl2 a.fall {\sc \cl2.det}	\\
...
\begin{xlist}
\ex     \gll \uline{\`mb\`\oo{\ng}} \ny\'{\i} $[$N\H{a}{\ng} h\H{a} l\Lbi{\ng}$]$ {\`\aw} \`u p\'\i\til{p\H{\i}}        \\
\cl1.cow {\sc rel} N. {\sc p1} a.look.for {\sc \cl1.det} \cl1 {\sc vfoc}\til{b.die} \\
\glt \elicited``The cow that Nang looked for died.'' (Abar)      \label{mg03a}
\ex     \gll \uline{\`mb\`\oo{\ng}} \ny\'{\i} $[$N\H{a}{\ng} h\H{a} l\Lbi{\ng} \uline{w\`u}$]$ {\`u}{\footnotemark} \`u p\'\i\til{p\H{\i}}     \\
\cl1.cow {\sc rel} N. {\sc p1} a.look.for {\sc \cl1.foc} {\sc \cl1.det} \cl1 {\sc vfoc}\til{b.die}  \\
...
\fbox{may or may not appear} as the object of the locative phrase~\ci{\'a\dots m\=\i}~\gl{inside of\dots}.
...
\cl7.{\sc dem.prox} {\sc \cl7.det} {\sc cop} \cl7-pan {\sc rel} \cl2 a.put.{\sc ipfv}
\cl4a-nkwi.bark {\sc \cl4a.det} {\sc prep} {\sc \cl7} {\sc loc.}in {\sc \cl7.det}   \\
...
1sg-{\sc p1} {\sc vfoc}\til{b.see} \cl5-place {\sc rel} N. {\sc p1} a.slaughter \cl10-fowl \cl10.{\sc det} (there)	\\
...
\z
	...
	\ea     \label{munken10}
        ...
        f\H{\@} gb\`e   \\
        \cl1-person {\sc rel} {\sc 1sg} {\sc p2/3} b.give \cl3-knife {\sc \cl1=dat} {\sc 1=}then
        {\sc p1} a.fall \\
...
\ea	\label{missong01a}
	...
	\cl1.{\sc nmlz}-a.fall-{\sc nmlz} {\sc rel} N. {\sc p1} a.fall \cl1 {\sc loc.at} {\sc \cl1.det} {\sc p1} {\sc vfoc}\til{c.bad}	\\
...
\ea 	\label{abar01a}
	\gll {u}w\`{\@}n\`{\aw} \`u l\H{\eh} \uline{\`u-n\`o} {\ny}\={\i} $[$\'n={\dzh}\=a \=\i-{\sh}\ML{\eh} \uline{j\`{\i}}$]$       \\
        1-{\sc dem.prox} \cl1 b.{\sc cop} \cl1-person {\sc rel} {\sc 1sg}=a.steal.{\sc irr} \cl9-fowl {\sc 3sg.poss}     \\
...
1sg-{\sc vfoc}\til{know} \cl7-matter {\sc rel} N. {\sc p1} fight {\sc com} \cl10-pig {\sc \cl10.det} {\sc \cl7.det}  \\
...
\cl5-{\sc dem.prox} \cl5-honey {\sc rel} \cl1-person a.stay.{\sc pfv} \cl1 b.be.drunk.{\sc irr}	\\
...
\cl5-sound \cl5-{\sc rel} \cl2 a.cut.{\sc ipfv} a.stay.{\sc ipfv} \cl7-tree {\sc \cl7.det} a.make.{\sc ipfv}
b.block.{\sc ipfv} a.stay.{\sc ipfv} {\sc 1sg.foc}	\\
...
\cl12-matter {\sc rel} \cl2-children {\sc \cl2.det} a.steal {\sc \cl9-fowl} {\sc 1sg.poss} {\sc \cl12.det}
b.worry {\sc 1sg.foc}	\\
...
\cl2 b.have \cl5-species \cl3-house \cl2 b.have \cl3-money	\\
...
\glt \elicited``This is not the fatigue that Nang was tired [i.e. that Nang experienced].''  (P1, Biya) %78r
%
...
\glt \elicited``This is the person$_i$ by whom$_i$ Mu made the goat be shown to Kulo.'' (P2, Abar)	%	2r 5-jul-2000
...
{\sc p2/3} b.give.{\sc irr} before {\sc \cl3.det}	\\ % 2r 26-jul-2010 (check this tone?)
\glt ``Give him that wisdom, the one which you have given before [to others].'' (P3, Munken) 
\end{exe}
%
\footnotetext{The tense markers for P2 and P3 are identical in all Mungbam varieties
except for in Biya. The tenses are distinguished by the fact that in P3 the verb
...
N. \cl10-goat \cl10.{\sc det} {\sc vfoc}\til{a.slaughter}	\\
...
\begin{xlist}
\ex	\gll N\H{a}{\ng} \'a b\'am h\={\aw}	\\
N. {\sc neg} c.ascend.{\sc irr} {\sc neg}	\\
...
N. a.slaughter \cl10-goat \cl10.{\sc det} {\sc loc.}stream	\\
\glt \elicited``Nang killed the goats at the stream.'' (Biya) 	%73v
\end{xlist}
\ex \label{mg1048}
\begin{xlist}
\ex \label{mg1048a}
*\`a gb\`u{\til}{gb\ML{e}} N\H{a}{\ng}	
\ex \label{mg1048b}
...
\ex	\label{mg104a}
\gll \uline{\`mb\`\oo{\ng}} \ny\'{\i} $[$N\H{a}{\ng} h\H{a} \{l\Lbi\ng~/~l\Lbi{n}\til{l\MLbi\ng}\}$]$ \`{\aw} \`u p\'\i{\til}p\H{\i}	\\
\cl1.cow {\sc rel} N. {\sc p1} (a.look~/~{\sc vfoc}\til{a.look}) {\sc \cl1.det} \cl1 {\sc vfoc}\til{b.die}	\\
\glt \elicited``The cow that Nang \{looked for~/~did look for\} died.'' (Abar)
\ex	\label{mg104b}
\gll \uline{\`mb\`\oo{\ng}} \ny\'{\i} $[$N\H{a}{\ng} h\H{a} \{l\Lbi\ng~/~*l\Lbi{n}\til{l\MLbi\ng}\} \uline{w\`u}$]$ \`{u}{\footnotemark} \`u p\'\i{\til}p\H{\i}	\\
\cl1.cow {\sc rel} N. {\sc p1} \{a.look~/~{\sc vfoc}\til{a.look}\} {\sc \cl1.foc} {\sc \cl1.det} \cl1 {\sc vfoc}\til{b.die}	\\
...
\begin{exe}
	...
	\ex \gll 	\uline{ŋwàtɨ̀} bi̋ bī-fyɨ̋ŋ b-ɛ́n bi̋-tɔ᷇ b-ɔ́ [nō̤ wù fə̌ ta̋ŋ bɔ́ Bàmɛ́ndà]		\\
			\cl7/8-book \cl8.1{\sc poss} \cl8-new \cl8-{\sc dem.prox} \cl8-three \cl8-{\sc det} {\sc subd} \cl1{\sc pro} P1 b.buy \cl8-{\sc rel} Bamenda 		\\
...
Having shown how the relative clause relates to its environment, this section will deal with 
relative clause marking, i.e., with the strategies used to identify a relative clause as such. 
...
which also introduces certain kinds of adverbial clauses, which we call the ``clause-initial subordinator.'' 
In this section we discuss first the post-verbal relativizer,
and then clause-initial subordinator.

\subsubsection{Postverbal relativizer}
The post-verbal relativizer, exemplified in~\pref{exSheSaidAyi}, is identical in shape with the definite determiner and the distal 
...
\begin{exe}
	\ex \label{exSheSaidAyi} 		
		...
		\cl1{\sc pro} b.say	{\sc excl} 1{\sc sg}={\sc fut}1	c.go\_up	there		\cl5/7.attic 	
		1{\sc sg}=a.go	a.see clearly	\cl7.thing	\cl7.{\sc pro}	a.make.{\sc ipfv}	c.extinguish.{\sc ipfv} 	b.move\_away.{\sc ipfv} \cl7-{\sc rel}	\cl5/7.fire	\cl5-{\sc det} \\
...
of relative clauses containing both a post-verbal 
...
\begin{exe}
	\ex \label{exTheFirstThing} 		
		...
		first	\cl7.thing	{\sc subd} 1{\sc sg}={\sc fut}2	a.do	\cl7-{\sc rel}	\cl7.{\sc pro}	{\sc cop}	{\sc compl}	... \\
		\glt \VSP \gl{The first thing I will do, is: [...]})
\end{exe}%Mundabli-01-Apr -2008-RMV-12.002
%\begin{exe}
%	\ex \label{exYouHaveSeenTheThings} 		
%		\gll à də̄ \uline{ndʒɔ́m} [\uline{bī} fɨ̋ bɔ́ ā wà] \\
%			2{\sc sg.pvb}	a.see	8.things	8.{\sc pro}	b.pass	8-{\sc det}	{\sc com}	2{\sc sg.pro.npvb} \\
...
derived from one of these historically, the post-verbal relativizer has lost its status as a 
...
fact that the post-verbal relativizer is always present, irrespective of the definiteness of the 
...
a post-nominal relativizer even though 
the head nominal is a 2{\sc sg} pronoun, which cannot be modified by a demonstrative or a determiner. 
%Example \ref{exWeAreLookingForACertainGoat} shows its use with a clearly indefinite head nominal.
%
%Having shown that the post-verbal relativizer is different from a resumptive pronoun, the next thing is to show that, although it is cognate with the definite determiner and the demonstrative pronoun, the post-verbal relativizer has lost its status as a modifier of the head nominal. The first and most obvious argument is related to the position of the post-verbal relativizer embedded in the relative clause. The post-verbal determiner is cliticized to the end of the relative verb, occurring in the middle of a relative clause when the verb is followed by an object or other post-verbal material. If the post-verbal relativizer were a modifier of the head nominal, this would be a case two constituents with interlocking word order. The fact that no other case of interlocking word order has been attested in Mundabli renders this unlikely. If we assume that the original determiner has grammaticalized and the post-verbal relativizer no more modifies the head nominal but is part of the relative clause, we do not have to consider this to be a case of discontinuous constituency.
%
%A stronger argument supporting that the post-verbal relativizer is no more a modifier of the head nominal is the fact that the post-verbal relativizer is always present, irrespective of the definiteness of the matrix NP. It is used in cases in which the head nominal itself could not be modified by a determiner, like e.g. when the head nominal is a pronoun referring to a speech act participant or a proper noun or when the matrix NP is indefinite (see \ref{exThisChildYouAre}, \ref{exWumWhichIsASmallTown1} and \ref{exWeAreLookingForACertainGoat}, respectively).

\begin{exe}
	\ex \label{exThisChildYouAre} 		
		\gll wān w-ɛ̄n, dɨ̌ \uline{wà} nō̤ [\uline{à} lə̄ w-ɔ̄ ná	mɨ̄ wān w-ɔ̄ lɛ̄ fán gbɔ̄ kúŋ]\\
			\cl1.child	\cl1-{\sc dem.prox} b.be	2{\sc sg.foc}	{\sc subd} 2{\sc sg.foc} a.make	\cl1-{\sc rel}	  as	1{\sc sg.foc} \cl1.child	\cl1-{\sc det}	a.make.ipfv	here \cl3.house	behind \\
...
When a relative clause modifies a non-third person pronoun, as in~\pref{exThisChildYouAre}, the post-verbal relativizer shows class 1 agreement.

%\begin{exe} 
%	\ex \label{exWumWhichIsASmallTown1}	
%		\gll Gə̂m \uline{kú} nō̤ [\uline{wù} dɨ̋ w-ɔ̄ kwe̋ a̋ fī-ntʃín] , kī ā tʃɨ̀ŋ wɔ̄ 			\\
%			Wum village.{\sc loc} {\sc rel} 1{\sc pro} b.be 1-{\sc det} 5/6.village {\sc advlz} 19-small , 7{\sc pro} {\sc neg}1 be\_far {\sc neg}2 \\
...
\begin{exe} 
	\ex \label{exGoatTheyKilled1}	
		\gll	\uline{dʒǔ} [nō̤ bə̄ kə̀ lǎ kpɨ̄ y-ɔ̄ tō b-ɔ́ ŋgɔ᷆] kə̀ bān áná būbūbūbū			\\
			\cl9.goat {\sc subd} 3{\sc impers.pro} P3 a.make b.die \cl9-{\sc rel} \cl7/8.day \cl8-{\sc dem} on/at P3 b.be\_white like\_that {\sc ideo}.white		\\
...
\begin{exe} 
	\ex \label{exThenFromThen}	
		\gll	then from then, mɨ̄ m=fə̋ kì-yùŋn{\`\ih} bɔ̌ gbàm lā nō̤ wù fə̋ ná kpɒ̋ ŋgɔ́ w-ɔ́ ndá lā			\\
			then from then 1{\sc sg.foc} 1{\sc top} \cl7-thanks also \cl7/8.god for {\sc subd} 1{\sc pro} b.give  as \cl5/7.money on/at \cl5-{\sc det} 1{\sc sg.pro.dat} for		\\
...
%			1{\sc pro} c.sing b.good b.pass b.pass as1 1{\sc pro} a.play as2		\\
...
%			2.children 2-{\sc det} b.hear as1 2-mother 2{\sc poss.pro} P3 b.say as2		\\
...
Considering the origin of the post-verbal relativizer, it is rather obvious that it must have grammaticalized 
...
Yemne-Kimbi languages and in the wider area, the only language we are aware of that has a post-verbal relativizer (shown in~\pref{exNaki}) comparable to the one found in Mundabli is Naki (Yemne-Kimbi). The fact that a variety of Naki, 
namely Mashi, is spoken in a village of the same name which is directly adjacent to Mundabli, 
suggests that language contact may have played a role and that, if the post-verbal relativizer is
...
%later adopted the post-verbal relativizer through contact with speakers of Naki, 
...
of these cases even involve an invariable marker which is similar in shape with the Mundabli subordinator. Nevertheless, in non of these languages relativization involves a post-verbal marker, like in Mundabli.
%
...
\begin{exe}
	\ex \label{exThePersonWhoWasPreaching2} 		
		...
		\cl1.man	3{\sc sg}	P3	b.say.{\sc ipfv}	\cl1-{\sc rel}	\cl3a.word \cl7/8.god	\cl7/8.day	\cl7-{\sc dist.dem}	 on/at	P3	b.be	Pa Peter Kia \\
...
%
%\begin{exe} 
%\ex     \label{exGoatTheyKillWithWithout}
%\begin{xlist}
%	\ex \label{exGoatTheyKilled2}	
%
%		\gll	\uline{dʒǔ} nō̤ [bə̄ kə̀ lǎ kpɨ̄ yɔ̄ tō b-ɔ́ ŋgɔ᷆] kə̀ bān áná būbūbūbū			\\
%			9.goat {\sc rel} {\sc impers.pro} P1 a.make b.die 9-{\sc det} 7/8.day 8-{\sc dem} on/at P3 b.be\_white like\_that IDEO.white		\\
...
\begin{exe} 
	\ex \label{exGoatTheyKilled2ResPro}	
		...
		\gll	\uline{dʒǔ} [nō̤ bə̄ kə̀ lǎ kpɨ̄ y-ɔ̄ (\uline{yì}) tō b-ɔ́ ŋgɔ᷆] kə̀ bān áná būbūbūbū			\\
			\cl9.goat {\sc subd} {\sc impers.pro} P1 a.make b.die \cl9-{\sc rel} \cl9.{\sc pro} \cl7/8.day \cl8-{\sc dem} on/at P3 b.be\_white like\_that {\sc ideo}.white		\\
...
%\begin{exe}
%	\ex     \label{exPotIntoWhichWithWithout}
%\begin{xlist}
%
%	\ex \label{exThePotIntoWhich1}	
%		\gll \uline{kpē} w-ɔ́ nō̤ [bɔ̋ fə̋ dʒī kūo ʃī wɔ̄ dɔ̄ w-ɔ́ mɨ́\comment{tone?}] , wū fə̋ ga̋ a̋ mò̤-mò̤	\\
%		3.pot 3-{\sc det} {\sc rel} 2{\sc pro} P1 a.put c.enter a.go\_down 3-{\sc det} w.beans w-{\sc det} in , 1{\sc pro} P1 b.be\_big {\sc advlz} much?-{\sc red} 	\\
...
\begin{exe}
	\ex \label{exThePotIntoWhich2}	
		...
		\cl3.pot \cl3-{\sc det} {\sc subd} \cl2{\sc pro} P1 a.put c.enter a.go\_down \cl3-{\sc rel} \cl3a.beans \cl3a-{\sc det} \cl5.{\sc pro} in \cl1{\sc pro} P1 b.be\_big {\sc advlz} much?-{\sc red} 	\\
		\glt \VSP \elicited \gl{The pot into which they put the beans was very big.}
\end{exe}%fieldnotes2012/p.50	%???
%\end{xlist}
%\end{exe}
...
post-verbal relativizer agrees with a locative proform glossed \gl{{\sc prox}}, likely
...
\begin{exe}
	\ex \label{exWhenYouHaveFinishedSquishing} 		
		\gll ká à wɔ̄ŋ mɛ̄, kə́ m̀=mū, mɨ̄ ntsɔ̀ \uline{dɛ̀} [nō̤ wān wā kə̀ fɨ̄ f-ɔ́]	\\
		when	2{\sc sg.top}	squish	finish		when	1{\sc sg}=drink	1{\sc sg.foc}	1{\sc sg}=show	?.place	{\sc subd}			\cl1.child		\cl1-2{\sc sg.poss}	P3	disappear	{\sc prox}-{\sc rel}	\\
...
%\begin{exe}
	\ex \label{exThePeopleForWhomWithPro}	
		\gll \uline{mbɛ̄} [nō̤ wù kə̀ dʒìɛ́ b-ɔ́ ({\H\ih}) \uline{bɔ̌} lā], bɔ̋ kə̀ fa᷆n	\\
		\cl2.people {\sc subd} \cl1{\sc pro} P3 b.cook.{\sc ipfv} \cl2-{\sc rel} ({\sc loc}) \cl2{\sc pro} for \cl2{\sc pro} P3 a.be\_rich	\\
...
%\begin{exe}
	\ex \label{exThePeopleForWhomOnlyPP}
		...
		\cl2.people {\sc subd} 1{\sc pro} P3 b.cook.{\sc ipfv} \cl2-{\sc rel} for \cl2{\sc pro} P3 a.be\_rich	\\
		\glt \VSP \elicited \gl{The people for whom she used to cook were rich.}
%\end{exe}%phone elicitation 26/06/2012
...
%		2.people {\sc rel} 1{\sc pro} P3 b.cook.{\sc ipfv} 2-{\sc det} {\sc loc} for , 2{\sc pro} P3 a.be\_rich	\\
...
%		9.knife {\sc rel} 1{\sc pro} P1 b.cut 9-{\sc det} 9.meat 9-{\sc det} {\sc com} 9-{\sc pro} , 9-{\sc pro} P1 a.be\_blunt	\\
...
%%\begin{exe}
	\ex \label{exTheKnifeThatSheCut}	
		...
		\cl9.knife {\sc subd} 1{\sc pro} P1 b.cut \cl9-{\sc rel} \cl9.meat \cl9-{\sc det} , \cl9-{\sc pro} P1 a.be\_blunt	\\
...
%		9.knife {\sc rel} 1{\sc pro} P1 b.cut 9-{\sc det} 9.meat 9-{\sc det} {\sc com}, 9-{\sc pro} P1 a.be\_blunt	\\
...
%		1{\sc sg.pro.pvb}=b.ask QUOT.Q Q , {\sc cop} what {\sc rel} 2{\sc sg.pro.pvb} b.refuse 7-{\sc det} 6a.wine 6a-{\sc det} 1{\sc sg.poss} hands.{\sc loc} Q.{\sc quot} \\
...
%		1{\sc pro} ?.take b.come ?.basket , 1{\sc pro} {\sc consec} ?.put ?.cassava ({\sc loc}) in	\\
...
%		1{\sc sg.pro}=a.love 7/8.clothes 7-{\sc det} {\sc rel} Nyungfu b.buy=7-{\sc det} 7{\sc pro}	\\
...
\begin{exe} 
	\ex \label{exGoatTheyKilled}	
		...
		\gll	\uline{dʒǔ} [nō̤ bə̄ kə̀ lǎ kpɨ̄ y-ɔ̄ tō b-ɔ́ ŋgɔ᷆] kə̀ bān áná būbūbūbū			\\
			\cl9.goat {\sc subd} 3{\sc pl.impers} P3 a.make b.die \cl9-{\sc rel} \cl7/8.day \cl8-{\sc dem} on/at P3 b.be\_white like\_that {\sc ideo}.white		\\
		\glt \VSP \elicited \gl{The goat which was killed on that day was completely white.} (literally: which one killed)
\end{exe}%Fieldnotes2012/1/p46(Elicitation)
...
\begin{exe}
	\ex \label{exChildWhomIGaveMoney}	
		...
		\gll	\uline{wàn} w-ɔ̄ [nō̤ m=fə̋ fə̋ w-ɔ̄ kpɒ̋ {\H\ih} \uline{wú} lā] kɛ́ tʃǔ a̋ kè-kè	\\
			\cl1.child \cl1-{\sc det} {\sc subd} 1{\sc sg.top}=P1 b.give	\cl1-{\sc rel} \cl5/7.money {\sc loc} 1{\sc pro} {\sc dat} c.return b.come {\sc advlz} \cl9.hand-{\sc red} 				\\
...
\begin{exe}
	\ex \label{exTheHoeWithWhich}	
		\gll	\uline{ŋkɔ̀m} [nō̤ ntí fə̋ lɔ̄ w-ɔ̄ ā \uline{wù}] kwa᷆ fɨ̌  	\\
			\cl1/2.hoe {\sc subd} Ntie P1 a.go\_bush	\cl1-{\sc rel} {\sc com} \cl1-{\sc pro} a.break b.pass 				\\
...
\begin{exe}
	\ex \label{exThePotIntoWhich}	
		...
		\cl3.pot \cl3-{\sc det} {\sc subd} 2{\sc pro} P1 a.put c.enter a.go\_down \cl3-{\sc rel} \cl3a.beans \cl3a-{\sc det} in \cl1{\sc pro} P1 b.be\_big {\sc advlz} much-{\sc red} 	\\
		\glt \VSP \gl{The pot into which they put the beans was very big.}
\end{exe}%fieldnotes2012/p.50	%???
...
\begin{exe} 
	\ex \label{exChildWhoseName}	
		...
		\gll	\uline{wān} [nō̤ mán \uline{mű} dɨ̋ w-ɔ̄ ngàʃǎ] fə̋ lɔ̀ nyu᷇				\\
			\cl1.child {\sc subd} \cl11/12.name \cl12.3{\sc sg.poss} {\sc cop} \cl1-{\sc rel} Ngasha P1 go\_bush farm		\\
...
%		7{\sc pro} {\sc cop} only 7/8.day 6a.corn\_beer 9(?).die 8-{\sc dem} {\sc rel} prop.name F2 b.come 8-{\sc det} with 9.goat	\\
...
%
%		\gll wɔ̄ táìm nō̤ [m̋mū mɛ̌ w-ɔ̄ ndʒɔ᷇m mɨ̋ŋ ɲwɛ́n]			\\
%		5?-{\sc dem} 1.time {\sc rel} 1{\sc sg.pro.pvb}=.take only 2-{\sc det} 8.things 8:1{\sc sg.poss} now		\\
...
\begin{exe}
	\ex \label{exTheSoundThatThey}	
		\gll 	dzɛ̋ nō̤ bə̄ gbā ná kpān w-ɔ́ fyá mɨ̄ ā fa̋m	\\
			\cl5/6-sound {\sc subd} {\sc impers.pro} a.cut.{\sc ipfv}  as \cl3.tree \cl3-{\sc det} b.give.{\sc ipfv} 1{\sc sg.foc} {\sc com} \cl7/8.problem	\\
...
%\comment{check F1 in relative clauses! All other tenses are expressed in the same way. (see notebook1/2012/p.93) Expressed differently from main clause? Possible to do the same but more commonly different.}
%
...
\begin{exe} 
	\ex \label{exTheManWhoBuiltWhose}	
		...
		\cl1.man {\sc subd} \cl1{\sc pro} c.build \cl1-{\sc rel} \cl3.house who b.die	\\
...
\begin{exe}
	\ex \label{exTheKnifeTheyCutWhat}	
		...
		\cl9-this {\sc cop} \cl9.knife {\sc subd} {\sc impers.pro} P1 b.cut \cl9-{\sc rel} what {\sc com} \cl9{\sc pro}	\\
...
\begin{exe}
	\ex \label{exWeLookFor}	
		...
		\gll 	b{\=\ih} tsè \uline{mɔ̀} [nō̤ fə̋ gīa w-ɔ̄ \uline{wù} dʒǔ y-ɔ̄]		\\
			1{\sc pl} a.search \cl1.man {\sc subd} P1 a.steal \cl1-{\sc rel} \cl1.{\sc pro} \cl9.goat \cl9-{\sc det}\\
...
\begin{exe}
	\ex \label{exILikeTheClothesThatNyungfu}	
		...
		1{\sc sg.pro}=a.love \cl7/8.clothes \cl7-{\sc det} {\sc subd} Nyungfu b.buy \cl7-{\sc rel} \cl7{\sc pro}	\\
...
a nominal other than the representative nominal is in focus. Note that the post-verbal relativizer precedes 
...
\begin{exe}
	\ex \label{exWeLookFor}	
		...
		\gll 	fán dɨ̋ \uline{mɔ̀} [nō̤ \uline{wù} tə́ kə̀ tʃū w-ɔ̄]	\\
			here b.be \cl1.man {\sc subd} \cl1.{\sc pro} {\sc vfoc} P3 b.come \cl1-{\sc rel}\\
...
%		 	7/8.day	certain	8.suffering 	catch	8-{\sc det} 1{\sc pro}	7/8.thousand cl.8-those	cl.8-five	{\sc neg}1 b.be	{\sc neg}2	\\
...
\begin{exe} 
	\ex \label{exTheyAreNotListening}	
		...
		\gll 	bī ā wṳ́ wɔ̄ ɲɔ̄ ni̋	\\
		 	\cl8.{\sc pro} {\sc neg} b.hear.{\sc ipfv} 	{\sc neg} b.talk	mother.3{\sc poss} \\
...
\begin{exe} 
	\ex \label{exIHaveNotTurnedFufu}	
		...
		\gll 	n=da̋ ɲɔ̋m wɔ̄ ɲa᷆m	\\
		 	1{\sc sg}=b.be.{\sc neg} b.turn\_fufu  {\sc neg} \cl14.fufu	\\
...
In relative clauses, only auxiliary negation is attested \pref{exTheyTookTheBag}. Mundabli differs in this respect from Mungbam, 
...
%\cl1-person {\sc rel} {\sc ds} {\sc neg} N. \cl1.{\sc top} a.insult \cl1.{\sc foc} {\sc frust} \cl1.{\sc top} {\sc vfoc}\til{die}	\\
...
\begin{exe} 
	\ex \label{exTheyTookTheBag}	
		...
		\gll 	bɔ̋ fə̋ mù \uline{bɔ̀} k-ɔ́ [nō̤ b{\=\ih} fə̋ dɨ̋ k-ɔ́ a̋ də̀ wɔ̄], bɔ̋ mɨ́ dʒì kǐ {\H\ih} kìa mɨ̄.	\\
		 	\cl2{\sc pro} P1 a.take	\cl7.bag \cl7-{\sc det} {\sc subd} 1{\sc pl.pro} F1 b.be \cl7-{\sc rel} {\sc neg} a.see {\sc neg} \cl2{\sc pro} {\sc consec} a.put \cl7-{\sc pro} {\sc loc} \cl9.basket in \\
		\glt \VSP \elicited \gl{They took the bag we did not see and put it into a basket.}
\end{exe}%%notebook1-2012 for more examples!

%Note that the post-verbal determiner occurs at the end of the verb, preceding the focused subject which stands in IAV-position. The fact that 
...
data are available, Noni \citepp{hyman:1981}{91--4}, and
Nchane \citepp{boutwell:2010}{18--9}, no such post-verbal particle is
found. 
...
two languages is still be explored more fully.}
%
