...
\begin{exe}
	...
	\ex \gll 	\uline{ŋwàtɨ̀} bi̋ bī-fyɨ̋ŋ b-ɛ́n bi̋-tɔ᷇ b-ɔ́ [nō̤ wù fə̌ ta̋ŋ b-ɔ́ Bàmɛ́ndà]		\\
			\cl7/8-book \cl8.1{\sc poss} \cl8-new \cl8-{\sc dem.prox} \cl8-three \cl8-{\sc det} {\sc subd} \cl1  {\sc p1} b.buy \cl8-{\sc rel} B. 		\\
...
\begin{exe}
	\ex \label{exSheSaidAyi} 		
		...
		\cl1  b.say	{\sc excl} {\sc 1sg.top}={\sc fut1}	c.go.up	there		\cl5/7.attic 	
		{\sc 1sg.top}=a.go	a.see clearly	\cl7.thing	\cl7	a.make.{\sc ipfv}	c.extinguish.{\sc ipfv} 	b.move.away.{\sc ipfv} \cl7-{\sc rel}	\cl5/7.fire	\cl5-{\sc det} \\
...
%		{\sc 1sg.top}=a.love 7/8.clothes 7-{dist.dem} {\sc rel} b.buy=7-{\sc det} name 7 	\\
...
%			{\sc 2sg.top.pvb}	a.see	8.things	8 	b.pass	8-{\sc det}	{\sc com}	{\sc 2sg.foc.npvb} \\
...
%			Wum village.{\sc loc} {\sc subd} \cl1  b.be \cl1-{\sc rel} \cl5/6.village {\sc advlz} \cl19-small , \cl7  {\sc neg}1 be.far {\sc neg}2 \\
...
%			1{\sc pl} a.search 9.goat 9.certain  {\sc rel}	 9  {\sc p1} c.run 9-{\sc det}						\\
...
%			1{\sc pl} a.search 9.goat {\sc rel}	 9  {\sc p1} c.run 9-{\sc det}						\\
...
%			1{\sc pl} a.search 9.goat 9-{\sc det} {\sc rel}	 9  {\sc p1} c.run 9-{\sc det}						\\
...
%			\cl1  c.sing b.good b.pass b.pass as \cl1  a.play as2		\\
...
%			\cl2.children \cl2-{\sc det} b.hear {\sc subd} \cl2-mother \cl2{\sc poss} {\sc p3} b.say as		\\
...
%		\cl3.pot \cl3-{\sc det} {\sc rel} \cl2  {\sc p1} a.put c.enter a.go.down \cl3-{\sc det} \cl3.beans \cl3-{\sc det} in \cl1  {\sc p1} b.be.big {\sc advlz} much?-{\sc red} 	\\
...
\begin{exe}
	\ex \label{exWhenYouHaveFinishedSquishing} 		
		\gll ká à wɔ̄ŋ mɛ̄, kə́ m̀=mū, mɨ̄ ntsɔ̀ \uline{dɛ̀} [nō̤ wān w-ā kə̀ fɨ̄ f-ɔ́]	\\
...
%		\cl2.people {\sc subd} \cl1  {\sc p3} b.cook.{\sc ipfv} \cl2-{\sc rel} {\sc loc} {\sc dat} \cl2  {\sc p3} a.be.rich	\\
...
%		\cl9.knife {\sc rel} \cl1  {\sc p1} b.cut \cl9-{\sc det} \cl9.meat \cl9-{\sc det} {\sc com} \cl9 \cl9 {\sc p1} a.be.blunt	\\
...
%		\cl9.knife {\sc subd} \cl1  {\sc p1} b.cut \cl9-{\sc det} \cl9.meat \cl9-{\sc det} {\sc com}, \cl9  {\sc p1} a.be.blunt	\\
...
%		{\sc 1sg.pvb}=b.ask QUOT.Q Q , b.be what {\sc rel} {\sc 2sg.top} b.refuse 7-{\sc det} 6a.wine 6a-{\sc det} {\sc 1sg.poss} hands.{\sc loc} Q.{\sc quot} \\
...
%		\cl1  ?.take b.come ?.basket , \cl1  {\sc consec} ?.put \cl?.cassava ({\sc loc}) in	\\
...
%		{\sc 1sg.top}=a.love 7/8.clothes 7-{\sc det} {\sc rel} Nyungfu b.buy=7-{\sc det} 7 	\\
...
\begin{exe} 
	\ex \label{exChildWhoseName}	
		...
		\gll	\uline{wān} [nō̤ mán \uline{mű} dɨ̋ w-ɔ̄ ngàʃǎ] fə̋ lɔ̀ nyu᷇				\\
			\cl1.child {\sc subd} \cl11/12.name \cl12.3{\sc sg.poss} b.be \cl1-{\sc rel} N. {\sc p1} a.go.bush \cl5/6.farm		\\
...
%		7  b.be only 7/8.day 6a.corn.beer 9(?).die 8-{\sc dem} {\sc rel} prop.name {\sc fut2} b.come 8-{\sc det} with 9.goat	\\
...
%		\cl1-{\sc dem} \cl1.time {\sc rel} {\sc 1sg.top}=a.take only \cl1-{\sc rel} \cl8.things \cl8:{\sc 1sg.poss} now		\\
...
%		 	\cl7/8.day	certain	\cl8.suffering 	catch	\cl8-{\sc rel} \cl1 	\cl7/8.thousand \cl8-those	\cl8-five	{\sc neg}1 b.be	{\sc neg}2	\\
...
\begin{exe} 
	\ex \label{exTheyTookTheBag}	
		...
		\gll 	bɔ̋ fə̋ mù \uline{bɔ̀} k-ɔ́ [nō̤ b{\=\ih} fə̋ dɨ̋ k-ɔ́ a̋ də̀ wɔ̄], bɔ̋ mɨ́ dʒì kǐ {\H\ih} kìa mɨ̄.	\\
		 	\cl2  {\sc p1} a.take	\cl7.bag \cl7-{\sc det} {\sc subd} {\sc 1pl} {\sc fut1} b.be \cl7-{\sc rel} {\sc neg} a.see {\sc neg} \cl2  {\sc consec} a.put \cl7  {\sc loc} \cl9.basket in \\
