...
% citation commands
\def\zSp{\hskip0.16667em\relax} % thin breaking space
%%%%%%%
...
\begin{tabular}{lll}
\Hline
\textsc{Mundabli}	&	\textsc{Munken}		&	\textsc{gloss}\\
\hline
...
Elicited sentences are indicated by a ${}^\diamond$~symbol in the free
translation.\footnote{Ungrammatical examples (marked with an asterisk)
do not require the ${}^\diamond$~symbol, since all are elicited.}
...
\glt `Its there [i.e. that's why] he is constantly struggling with flies disturbing him [landing] on his comb.' (Abar) % 6r 28-apr-2010
...
\glt {\elicited`It is there that [i.e. thats why] he is constantly struggling with flies on his comb.' (Abar)} 	%124r
\end{xlist}
\end{exe}
%
%
...
\z
        ...
        \glt `That knife that you work with in the kitchen\dots' (Munken)  %       MK 04-05-2010 2V        00:03:18 tape 2
\z
...
\glt `They have the kind of house [that suggests that] they have money.' (Munken) %2r 16-jul2010
\z
%
...
\begin{xlist}
\ex	\gll N\H{a}{\ng} \'a b\'am h\={\aw}	\\
N. {\sc neg} ({\sc c})accept.{\sc irr} {\sc neg}	\\
