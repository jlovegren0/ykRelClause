...
\begin{exe}
	...
	\ex \gll 	\uline{ŋwàtɨ̀} bi̋ bī-fyɨ̋ŋ b-ɛ́n bi̋-tɔ᷇ b-ɔ́ [nō̤ wù fə̌ ta̋ŋ b-ɔ́ Bàmɛ́ndà]		\\
			\cl7/8-book \cl8.{\sc 3sg.poss} \cl8-new \cl8-{\sc dem.prox} \cl8-three \cl8-{\sc det} {\sc subd} \cl1  {\sc p1} b.buy \cl8-{\sc rel} B. 		\\
...
%		{\sc 1sg.top}=a.love 7/8.clothes 7-{det} {\sc rel} b.buy 7-{\sc det} name 7 	\\
...
%			Wum {\sc loc}.village {\sc subd} \cl1  b.be \cl1-{\sc rel} \cl5/6.village {\sc advlz} \cl19-small , \cl7  {\sc neg}1 be.far {\sc neg}2 \\
...
varieties occur in free alternation.}

\begin{exe} 
	\ex \label{exGoatTheyKilled1}	
		\gll	\uline{dʒǔ} [nō̤ bə̄ kə̀ lǎ kpɨ̄ y-ɔ̄ tō b-ɔ́ ŋgɔ᷆] kə̀ bān áná būbūbūbū			\\
			\cl9.goat {\sc subd} {\sc impers.pro} {\sc p3} a.make b.die \cl9-{\sc rel} \cl7/8.day \cl8-{\sc det} upon {\sc p3} b.be.white like.that {\sc ideo}.white		\\
...
%			\cl2.children \cl2-{\sc det} b.hear {\sc subd} \cl2-mother {\sc 3pl.poss} {\sc p3} b.say as		\\
...
\begin{exe} 
	\ex \label{exGoatTheyKilled2ResPro}	
		...
		\gll	\uline{dʒǔ} [nō̤ bə̄ kə̀ lǎ kpɨ̄ y-ɔ̄ (\uline{yì}) tō b-ɔ́ ŋgɔ᷆] kə̀ bān áná būbūbūbū			\\
			\cl9.goat {\sc subd} {\sc impers.pro} {\sc p1} a.make b.die \cl9-{\sc rel} \cl9  \cl7/8.day \cl8-{\sc det} upon {\sc p3} b.be.white like.that {\sc ideo}.white		\\
		\glt \VSP \elicited \gl{The goat which was killed on that day was completely white.}
%\end{xlist}
\end{exe}%Fieldnotes2012/1/p46(Elicitation)
...
%		{\sc 1sg.top}=b.ask QUOT.Q Q , b.be what {\sc rel} {\sc 2sg.top} b.refuse 7-{\sc det} 6a.wine 6a-{\sc det} {\sc 2sg.foc}-N hands.{\sc loc} Q.{\sc quot} \\
...
%		7  b.be only 7/8.day 6a.corn.beer 9(?).die 8-{\sc det} {\sc rel} prop.name {\sc fut2} b.come 8-{\sc det} with 9.goat	\\
...
\footnotetext{The class 8 pronoun is used in an abusive manner to refer to people.}
