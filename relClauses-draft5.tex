...
\begin{exe}
	\ex \label{exSheSaidAyi} 		
		...
		\cl1{\sc pro} b.say	{\sc excl} 1{\sc sg}={\sc fut}1	c.go.up	there		\cl5/7.attic 	
		1{\sc sg}=a.go	a.see clearly	\cl7.thing	\cl7.{\sc pro}	a.make.{\sc ipfv}	c.extinguish.{\sc ipfv} 	b.move.away.{\sc ipfv} \cl7-{\sc rel}	\cl5/7.fire	\cl5-{\sc det} \\
...
%			Wum village.{\sc loc} {\sc rel} 1{\sc pro} b.be 1-{\sc det} 5/6.village {\sc advlz} 19-small , 7{\sc pro} {\sc neg}1 be.far {\sc neg}2 \\
...
\begin{exe} 
	\ex \label{exGoatTheyKilled1}	
		\gll	\uline{dʒǔ} [nō̤ bə̄ kə̀ lǎ kpɨ̄ y-ɔ̄ tō b-ɔ́ ŋgɔ᷆] kə̀ bān áná būbūbūbū			\\
			\cl9.goat {\sc subd} 3{\sc impers.pro} P3 a.make b.die \cl9-{\sc rel} \cl7/8.day \cl8-{\sc dem} on/at P3 b.be.white like.that {\sc ideo}.white		\\
...
\begin{exe}
	\ex \label{exThePersonWhoWasPreaching2} 		
		...
		\cl1.man	\cl1{\sc pro}	P3	b.say.{\sc ipfv}	\cl1-{\sc rel}	\cl3a.word \cl7/8.god	\cl7/8.day	\cl7-{\sc dist.dem}	 on/at	P3	b.be	Pa Peter Kia \\
...
%			9.goat {\sc rel} {\sc impers.pro} P1 a.make b.die 9-{\sc det} 7/8.day 8-{\sc dem} on/at P3 b.be.white like.that IDEO.white		\\
...
\begin{exe} 
	\ex \label{exGoatTheyKilled2ResPro}	
		...
		\gll	\uline{dʒǔ} [nō̤ bə̄ kə̀ lǎ kpɨ̄ y-ɔ̄ (\uline{yì}) tō b-ɔ́ ŋgɔ᷆] kə̀ bān áná būbūbūbū			\\
			\cl9.goat {\sc subd} {\sc impers.pro} P1 a.make b.die \cl9-{\sc rel} \cl9.{\sc pro} \cl7/8.day \cl8-{\sc dem} on/at P3 b.be.white like.that {\sc ideo}.white		\\
...
%		3.pot 3-{\sc det} {\sc rel} 2{\sc pro} P1 a.put c.enter a.go.down 3-{\sc det} w.beans w-{\sc det} in , 1{\sc pro} P1 b.be.big {\sc advlz} much?-{\sc red} 	\\
...
\begin{exe}
	\ex \label{exThePotIntoWhich2}	
		...
		\cl3.pot \cl3-{\sc det} {\sc subd} \cl2{\sc pro} P1 a.put c.enter a.go.down \cl3-{\sc rel} \cl3a.beans \cl3a-{\sc det} \cl5.{\sc pro} in \cl1{\sc pro} P1 b.be.big {\sc advlz} much?-{\sc red} 	\\
		\glt \VSP \elicited \gl{The pot into which they put the beans was very big.}
\end{exe}%fieldnotes2012/p.50	%???
%\end{xlist}
%\end{exe}
...
\begin{exe}
	\ex \label{exWhenYouHaveFinishedSquishing} 		
		...
		when	2{\sc sg.top}	squish	finish		when	1{\sc sg}=drink	1{\sc sg.foc}	1{\sc sg}=show	\cl?.place	{\sc subd}			\cl1.child		\cl1-2{\sc sg.poss}	P3	disappear	{\sc prox}-{\sc rel}	\\
...
%\begin{exe}
	\ex \label{exThePeopleForWhomWithPro}	
		...
		\cl2.people {\sc subd} \cl1{\sc pro} P3 b.cook.{\sc ipfv} \cl2-{\sc rel} ({\sc loc}) \cl2{\sc pro} for \cl2{\sc pro} P3 a.be.rich	\\
...
%\begin{exe}
	\ex \label{exThePeopleForWhomOnlyPP}
		...
		\cl2.people {\sc subd} 1{\sc pro} P3 b.cook.{\sc ipfv} \cl2-{\sc rel} for \cl2{\sc pro} P3 a.be.rich	\\
		\glt \VSP \elicited \gl{The people for whom she used to cook were rich.}
%\end{exe}%phone elicitation 26/06/2012
...
%		2.people {\sc rel} 1{\sc pro} P3 b.cook.{\sc ipfv} 2-{\sc det} {\sc loc} for , 2{\sc pro} P3 a.be.rich	\\
...
%		9.knife {\sc rel} 1{\sc pro} P1 b.cut 9-{\sc det} 9.meat 9-{\sc det} {\sc com} 9-{\sc pro} , 9-{\sc pro} P1 a.be.blunt	\\
...
%%\begin{exe}
	\ex \label{exTheKnifeThatSheCut}	
		...
		\cl9.knife {\sc subd} 1{\sc pro} P1 b.cut \cl9-{\sc rel} \cl9.meat \cl9-{\sc det} , \cl9-{\sc pro} P1 a.be.blunt	\\
...
%		9.knife {\sc rel} 1{\sc pro} P1 b.cut 9-{\sc det} 9.meat 9-{\sc det} {\sc com}, 9-{\sc pro} P1 a.be.blunt	\\
...
\begin{exe} 
	\ex \label{exGoatTheyKilled}	
		...
		\gll	\uline{dʒǔ} [nō̤ bə̄ kə̀ lǎ kpɨ̄ y-ɔ̄ tō b-ɔ́ ŋgɔ᷆] kə̀ bān áná būbūbūbū			\\
			\cl9.goat {\sc subd} 3{\sc pl.impers} P3 a.make b.die \cl9-{\sc rel} \cl7/8.day \cl8-{\sc dem} on/at P3 b.be.white like.that {\sc ideo}.white		\\
		\glt \VSP \elicited \gl{The goat which was killed on that day was completely white.} (literally: which one killed)
\end{exe}%Fieldnotes2012/1/p46(Elicitation)
...
\begin{exe}
	\ex \label{exTheHoeWithWhich}	
		\gll	\uline{ŋkɔ̀m} [nō̤ ntí fə̋ lɔ̄ w-ɔ̄ ā \uline{wù}] kwa᷆ fɨ̌  	\\
			\cl1/2.hoe {\sc subd} Ntie P1 a.go.bush	\cl1-{\sc rel} {\sc com} \cl1-{\sc pro} a.break b.pass 				\\
...
\begin{exe}
	\ex \label{exThePotIntoWhich}	
		...
		\cl3.pot \cl3-{\sc det} {\sc subd} 2{\sc pro} P1 a.put c.enter a.go.down \cl3-{\sc rel} \cl3a.beans \cl3a-{\sc det} in \cl1{\sc pro} P1 b.be.big {\sc advlz} much-{\sc red} 	\\
...
\begin{exe} 
	\ex \label{exChildWhoseName}	
		...
		\gll	\uline{wān} [nō̤ mán \uline{mű} dɨ̋ w-ɔ̄ ngàʃǎ] fə̋ lɔ̀ nyu᷇				\\
			\cl1.child {\sc subd} \cl11/12.name \cl12.3{\sc sg.poss} {\sc cop} \cl1-{\sc rel} Ngasha P1 go.bush farm		\\
...
%		7{\sc pro} {\sc cop} only 7/8.day 6a.corn.beer 9(?).die 8-{\sc dem} {\sc rel} prop.name F2 b.come 8-{\sc det} with 9.goat	\\
...
\begin{exe} 
	\ex \label{exIHaveNotTurnedFufu}	
		...
		\gll 	n=da̋ ɲɔ̋m wɔ̄ ɲa᷆m	\\
		 	1{\sc sg}=b.be.{\sc neg} b.turn.fufu  {\sc neg} \cl14.fufu	\\
