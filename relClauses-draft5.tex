...
\begin{exe}
	...
	\ex \gll 	\uline{ŋwàtɨ̀} bi̋ bī-fyɨ̋ŋ b-ɛ́n bi̋-tɔ᷇ b-ɔ́ [nō̤ wù fə̌ ta̋ŋ b-ɔ́ Bàmɛ́ndà]		\\
			\cl7/8-book \cl8.1{\sc poss} \cl8-new \cl8-{\sc dem.prox} \cl8-three \cl8-{\sc det} {\sc subd} \cl1{\sc pro} {\sc p1} b.buy \cl8-{\sc rel} Bamenda 		\\
...
%			1{\sc pl.pro} a.search 9.goat 9.certain  {\sc rel}	 9.{\sc pro} {\sc p1} c.run 9-{\sc det}						\\
...
%			1{\sc pl.pro} a.search 9.goat {\sc rel}	 9.{\sc pro} {\sc p1} c.run 9-{\sc det}						\\
...
%			1{\sc pl.pro} a.search 9.goat 9-{\sc det} {\sc rel}	 9.{\sc pro} {\sc p1} c.run 9-{\sc det}						\\
...
\begin{exe} 
	\ex \label{exGoatTheyKilled1}	
		\gll	\uline{dʒǔ} [nō̤ bə̄ kə̀ lǎ kpɨ̄ y-ɔ̄ tō b-ɔ́ ŋgɔ᷆] kə̀ bān áná būbūbūbū			\\
			\cl9.goat {\sc subd} 3{\sc impers.pro} {\sc p3} a.make b.die \cl9-{\sc rel} \cl7/8.day \cl8-{\sc dem} upon {\sc p3} b.be.white like.that {\sc ideo}.white		\\
...
\begin{exe} 
	\ex \label{exThenFromThen}	
		\gll	then from then, mɨ̄ m=fə̋ kì-yùŋn{\`\ih} bɔ̌ gbàm lā nō̤ wù fə̋ ná kpɒ̋ ŋgɔ́ w-ɔ́ ndá lā			\\
			then from then 1{\sc sg.foc} 1{\sc sg.top} \cl7-thanks also \cl7/8.god for {\sc subd} 1{\sc pro} b.give  as \cl5/7.money upon\cl5-{\sc det} 1{\sc sg.pro.dat} for		\\
...
%			2.children 2-{\sc det} b.hear as1 2-mother 2{\sc poss.pro} {\sc p3} b.say as2		\\
...
\begin{exe}
	\ex \label{exThePersonWhoWasPreaching2} 		
		...
		\cl1.man	\cl1{\sc pro}	{\sc p3}	b.say.{\sc ipfv}	\cl1-{\sc rel}	\cl3a.word \cl7/8.god	\cl7/8.day	\cl7-{\sc dist.dem}	 on/at	{\sc p3}	b.be	Pa Peter Kia \\
...
%			9.goat {\sc rel} {\sc impers.pro} {\sc p1} a.make b.die 9-{\sc det} 7/8.day 8-{\sc dem} upon {\sc p3} b.be.white like.that IDEO.white		\\
...
\begin{exe} 
	\ex \label{exGoatTheyKilled2ResPro}	
		...
		\gll	\uline{dʒǔ} [nō̤ bə̄ kə̀ lǎ kpɨ̄ y-ɔ̄ (\uline{yì}) tō b-ɔ́ ŋgɔ᷆] kə̀ bān áná būbūbūbū			\\
			\cl9.goat {\sc subd} {\sc impers.pro} {\sc p1} a.make b.die \cl9-{\sc rel} \cl9.{\sc pro} \cl7/8.day \cl8-{\sc dem} upon {\sc p3} b.be.white like.that {\sc ideo}.white		\\
...
%		3.pot 3-{\sc det} {\sc rel} 2{\sc pro} {\sc p1} a.put c.enter a.go.down 3-{\sc det} w.beans w-{\sc det} in , 1{\sc pro} {\sc p1} b.be.big {\sc advlz} much?-{\sc red} 	\\
...
\begin{exe}
	\ex \label{exThePotIntoWhich2}	
		...
		\cl3.pot \cl3-{\sc det} {\sc subd} \cl2{\sc pro} {\sc p1} a.put c.enter a.go.down \cl3-{\sc rel} \cl3a.beans \cl3a-{\sc det} \cl5.{\sc pro} in \cl1{\sc pro} {\sc p1} b.be.big {\sc advlz} much?-{\sc red} 	\\
		\glt \VSP \elicited \gl{The pot into which they put the beans was very big.}
\end{exe}%fieldnotes2012/p.50	%???
%\end{xlist}
%\end{exe}
...
\begin{exe}
	\ex \label{exWhenYouHaveFinishedSquishing} 		
		...
		when	2{\sc sg.top}	squish	finish		when	1{\sc sg}=drink	1{\sc sg.foc}	1{\sc sg}=show	\cl?.place	{\sc subd}			\cl1.child		\cl1-2{\sc sg.poss}	{\sc p3}	disappear	{\sc prox}-{\sc rel}	\\
...
%\begin{exe}
	\ex \label{exThePeopleForWhomWithPro}	
		...
		\cl2.people {\sc subd} \cl1{\sc pro} {\sc p3} b.cook.{\sc ipfv} \cl2-{\sc rel} ({\sc loc}) \cl2{\sc pro} for \cl2{\sc pro} {\sc p3} a.be.rich	\\
...
%\begin{exe}
	\ex \label{exThePeopleForWhomOnlyPP}
		...
		\cl2.people {\sc subd} 1{\sc pro} {\sc p3} b.cook.{\sc ipfv} \cl2-{\sc rel} for \cl2{\sc pro} {\sc p3} a.be.rich	\\
		\glt \VSP \elicited \gl{The people for whom she used to cook were rich.}
%\end{exe}%phone elicitation 26/06/2012
...
%		2.people {\sc rel} 1{\sc pro} {\sc p3} b.cook.{\sc ipfv} 2-{\sc det} {\sc loc} for , 2{\sc pro} {\sc p3} a.be.rich	\\
...
%		9.knife {\sc rel} 1{\sc pro} {\sc p1} b.cut 9-{\sc det} 9.meat 9-{\sc det} {\sc com} 9-{\sc pro} , 9-{\sc pro} {\sc p1} a.be.blunt	\\
...
%%\begin{exe}
	\ex \label{exTheKnifeThatSheCut}	
		...
		\cl9.knife {\sc subd} 1{\sc pro} {\sc p1} b.cut \cl9-{\sc rel} \cl9.meat \cl9-{\sc det} , \cl9-{\sc pro} {\sc p1} a.be.blunt	\\
...
%		9.knife {\sc rel} 1{\sc pro} {\sc p1} b.cut 9-{\sc det} 9.meat 9-{\sc det} {\sc com}, 9-{\sc pro} {\sc p1} a.be.blunt	\\
...
\begin{exe} 
	\ex \label{exGoatTheyKilled}	
		...
		\gll	\uline{dʒǔ} [nō̤ bə̄ kə̀ lǎ kpɨ̄ y-ɔ̄ tō b-ɔ́ ŋgɔ᷆] kə̀ bān áná būbūbūbū			\\
			\cl9.goat {\sc subd} 3{\sc pl.impers} {\sc p3} a.make b.die \cl9-{\sc rel} \cl7/8.day \cl8-{\sc dem} upon {\sc p3} b.be.white like.that {\sc ideo}.white		\\
		\glt \VSP \elicited \gl{The goat which was killed on that day was completely white.} (literally: which one killed)
\end{exe}%Fieldnotes2012/1/p46(Elicitation)
...
\begin{exe}
	\ex \label{exChildWhomIGaveMoney}	
		...
		\gll	\uline{wàn} w-ɔ̄ [nō̤ m=fə̋ fə̋ w-ɔ̄ kpɒ̋ {\H\ih} \uline{wú} lā] kɛ́ tʃǔ a̋ kè-kè	\\
			\cl1.child \cl1-{\sc det} {\sc subd} 1{\sc sg.top}={\sc p1} b.give	\cl1-{\sc rel} \cl5/7.money {\sc loc} 1{\sc pro} {\sc dat} c.return b.come {\sc advlz} \cl9.hand-{\sc red} 				\\
...
\begin{exe}
	\ex \label{exTheHoeWithWhich}	
		\gll	\uline{ŋkɔ̀m} [nō̤ ntí fə̋ lɔ̄ w-ɔ̄ ā \uline{wù}] kwa᷆ fɨ̌  	\\
			\cl1/2.hoe {\sc subd} Ntie {\sc p1} a.go.bush	\cl1-{\sc rel} {\sc com} \cl1-{\sc pro} a.break b.pass 				\\
...
\begin{exe}
	\ex \label{exThePotIntoWhich}	
		...
		\cl3.pot \cl3-{\sc det} {\sc subd} 2{\sc pro} {\sc p1} a.put c.enter a.go.down \cl3-{\sc rel} \cl3a.beans \cl3a-{\sc det} in \cl1{\sc pro} {\sc p1} b.be.big {\sc advlz} much-{\sc red} 	\\
...
\begin{exe} 
	\ex \label{exChildWhoseName}	
		...
		\gll	\uline{wān} [nō̤ mán \uline{mű} dɨ̋ w-ɔ̄ ngàʃǎ] fə̋ lɔ̀ nyu᷇				\\
			\cl1.child {\sc subd} \cl11/12.name \cl12.3{\sc sg.poss} {\sc cop} \cl1-{\sc rel} Ngasha {\sc p1} a.go.bush \cl5/6.farm		\\
...
%		7{\sc pro} {\sc cop} only 7/8.day 6a.corn.beer 9(?).die 8-{\sc dem} {\sc rel} prop.name {\sc fut2} b.come 8-{\sc det} with 9.goat	\\
...
\begin{exe}
	\ex \label{exTheKnifeTheyCutWhat}	
		...
		\cl9-this {\sc cop} \cl9.knife {\sc subd} {\sc impers.pro} {\sc p1} b.cut \cl9-{\sc rel} what {\sc com} \cl9{\sc pro}	\\
...
\begin{exe}
	\ex \label{exWeLookFor}	
		...
		\gll 	b{\=\ih} tsè \uline{mɔ̀} [nō̤ fə̋ gīa w-ɔ̄ \uline{wù} dʒǔ y-ɔ̄]		\\
			1{\sc pl} a.search \cl1.man {\sc subd} {\sc p1} a.steal \cl1-{\sc rel} \cl1.{\sc pro} \cl9.goat \cl9-{\sc det}\\
...
\begin{exe}
	\ex \label{exWeLookFor}	
		...
		\gll 	fán dɨ̋ \uline{mɔ̀} [nō̤ \uline{wù} tə́ kə̀ tʃū w-ɔ̄]	\\
			here b.be \cl1.man {\sc subd} \cl1.{\sc pro} {\sc vfoc} {\sc p3} b.come \cl1-{\sc rel}\\
...
\begin{exe} 
	\ex \label{exTheyTookTheBag}	
		...
		\gll 	bɔ̋ fə̋ mù \uline{bɔ̀} k-ɔ́ [nō̤ b{\=\ih} fə̋ dɨ̋ k-ɔ́ a̋ də̀ wɔ̄], bɔ̋ mɨ́ dʒì kǐ {\H\ih} kìa mɨ̄.	\\
		 	\cl2{\sc pro} {\sc p1} a.take	\cl7.bag \cl7-{\sc det} {\sc subd} 1{\sc pl.pro} {\sc fut1} b.be \cl7-{\sc rel} {\sc neg} a.see {\sc neg} \cl2{\sc pro} {\sc consec} a.put \cl7-{\sc pro} {\sc loc} \cl9.basket in \\
